...
AFlappyBirdCharacter::AFlappyBirdCharacter(const FObjectInitializer& ObjectInitializer)
...
void AFlappyBirdCharacter::SetupPlayerInputComponent(class UInputComponent* InputComponent)
{
	// Note: the 'Jump' action and the 'MoveRight' axis are bound to actual keys/buttons/sticks in DefaultInput.ini (editable from Project Settings..Input)
	InputComponent->BindAction("Jump", IE_Pressed, this, &ACharacter::Jump);
	InputComponent->BindAction("Jump", IE_Released, this, &ACharacter::StopJumping);
	//InputComponent->BindAxis("MoveRight", this, &AFlappyBirdCharacter::MoveRight);

	//InputComponent->BindTouch(IE_Pressed, this, &AFlappyBirdCharacter::TouchStarted);
	//InputComponent->BindTouch(IE_Released, this, &AFlappyBirdCharacter::TouchStopped);
}
